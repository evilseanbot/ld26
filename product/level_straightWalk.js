Crafty.c("Level_StraightWalk", {
    init: function() {
		...
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 1*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 2*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 3*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 4*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 5*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 6*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 7*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 8*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 9*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 10*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 11*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 12*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 13*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 14*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 15*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 16*64, y:4*64, alpha: 0});
		Crafty.e("2D, Canvas, Sprite, guardRail, red, Lightable").attr({x: 17*64, y:4*64, alpha: 0});
